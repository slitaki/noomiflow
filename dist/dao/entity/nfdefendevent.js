...
exports.NfDefEndevent = void 0;
const relaen_1 = require("relaen");
const nfdefnode_1 = require("./nfdefnode");
let NfDefEndevent = class NfDefEndevent extends relaen_1.BaseEntity {
...
], NfDefEndevent.prototype, "nfDefNode", void 0);
__decorate([
    relaen_1.Column({
        name: 'VER',
        type: 'int',
...
], NfDefEndevent.prototype, "vER", void 0);
NfDefEndevent = __decorate([
    relaen_1.Entity('NF_DEF_ENDEVENT'),
    __metadata("design:paramtypes", [nfdefnode_1.NfDefNode])
], NfDefEndevent);
exports.NfDefEndevent = NfDefEndevent;
//# sourceMappingURL=nfdefendevent.js.map